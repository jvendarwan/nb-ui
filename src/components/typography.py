...
class Typography(ComponentBase):
    ...
    def __init__(self, text: str, variant: str = 'body1', 
                 color: str = 'text', align: str = 'left',
                 gutterBottom: bool = False, noWrap: bool = False,
                 weight: Optional[str] = None, style: Optional[str] = None,
    ...
    def render(self) -> str:
        ...
        tag_map = {
            ...
            'body1': 'p', 'body2': 'p', 'subtitle1': 'h6', 'subtitle2': 'h6',
            'caption': 'span', 'button': 'span', 'overline': 'span'
        }
        ...
        font_weight = self.weight if self.weight else typo_styles.get('fontWeight', '400')
